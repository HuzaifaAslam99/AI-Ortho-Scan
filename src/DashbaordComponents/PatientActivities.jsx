...
const Patient_Achievement = () => {
  return (
    <div className='w-[80%] py-[30px] bg-dark-blue rounded-[10px] flex justify-evenly max-1350:grid max-1350:grid-cols-2
      ...
      '>
       ...
       <div className="achievementBox">
        ...
        <span className='text-[14px] max-400:text-[11px]'>Days Since Last Scan</span>

    ...
    <div className='w-[100%] px-[20px] py-[20px] bg-dark-blue rounded-[10px] flex flex-col gap-[20px] max-800:w-[100%]'>
       ...
       <div className="flex gap-[40px]  max-650:gap-[25px] max-480:gap-[15px]">
            ...
            <div className="Report">
               ...
               <span className="Report-text-extend">Fracture</span>
               <span className="Report-text-extend">Complexity: Mild</span>
               <span className="Report-text-extend">Confidence Score</span>
               <span className="Report-text-extend">Days passed in Rehabilitation</span> 
            </div>
            ...
            <div className="Report gap-[20px] max-650:gap-[10px]">
               <div className='Report-text'>Sales</div>
               <span className='Report-color-box text-orange-400 bg-opacity-15 bg-orange-600 border border-orange-500'>1</span>
               <span className='Report-color-box text-green-300 bg-opacity-15 bg-green-300 border border-green-300'>57%</span>
               <span className='Report-color-box text-blue-500 bg-opacity-15 bg-blue-500 border border-blue-500'>92%</span>
               <span className='Report-color-box text-red-300 bg-opacity-15 bg-red-300 border border-red-300'>17</span>
